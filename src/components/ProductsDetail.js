          ...
          <div className="flex justify-center">
            <div className="mb-8 shadow-lg bg-white rounded-lg mt-8 flex w-[900px] relative border border-gray-400">
              ...
              <div className="p-8 absolute left-[300px]">
                <div className="font-semibold flex gap-7 pb-8">Ürün Adı: <p className="font-normal">{item.title}</p></div>
                <div className="font-semibold flex gap-2 pb-4"><span>Ürün Açıklaması:</span> <p className="font-normal">{item.description}</p></div>
